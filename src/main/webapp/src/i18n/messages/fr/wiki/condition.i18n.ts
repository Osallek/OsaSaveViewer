const wikiCondition = {
  ...
  'wiki.condition.num_of_owned_provinces_with': 'Au moins {nb, plural, =0 {Aucun de nos provinces ne remplit} =1 {une de nos provinces remplit} other {# de nos provinces remplissent}} les conditions suivantes',
  'wiki.condition.num_of_owned_provinces_with.not': 'Moins de {nb, plural, =0 {0 remplit} =1 {une de nos provinces remplit} other {# de nos provinces remplissent}} les conditions suivantes',
  ...
  'wiki.condition.any_owned_province.not': 'Aucune province possédée ne remplit les conditions suivantes',
