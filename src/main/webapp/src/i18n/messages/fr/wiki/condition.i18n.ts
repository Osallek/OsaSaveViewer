const wikiCondition = {
  ...
  'wiki.condition.owns_or_non_sovereign_subject_of': 'Nous possédons ou une dépendance non tributaire possédons',
  ...
  'wiki.condition.any_known_country.not': 'Aucun pays connu remplit les conditions suivantes',
  'wiki.condition.any_ally': 'N\'importe quel allié connu remplit les conditions suivantes',
  'wiki.condition.any_ally.not': 'Aucun allié remplit les conditions suivantes',
  ...
  'wiki.condition.super_region.clause.all': 'Toutes provinces sur le continent {super_region}',
  'wiki.condition.region.clause.all': 'Toutes les provinces dans la région {region}',
  'wiki.condition.area.clause.all': 'Toutes les provinces dans l\'état {area}',
  ...
  'wiki.condition.ideaGroup.2': 'idées dans le groupe',
  'wiki.condition.ideaGroup.2.not': 'idées dans le groupe',
