const wikiCondition = {
  ...
  'wiki.condition.num_of_owned_provinces_with': 'Au moins {nb} provinces remplissent les conditions suivantes',
  'wiki.condition.num_of_owned_provinces_with.not': 'Moins de {nb} provinces remplissent les conditions suivantes',
  ...
  'wiki.condition.years_of_income.2': 'an(s) de revenue',
